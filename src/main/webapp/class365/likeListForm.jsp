...
<!-- main lecture list section --> 
	...
	<div class="container" style="margin-top:30px; max-width:fit-content;"> 
	<h2>찜한목록</h2>
		<div class="row">  	
			<div class="col">
				<input class="btn" type="button" value="찜한목록">
				<input class="btn" type="button" value="내강의">
	...
	<div class="cb_orange" style="width:100%; height:500px; ">
		<span class="c_font_main cc_white">찜목록 페이지 입니다.</span> 
	</div>
