		...
		<div id="tutor_main_article">
			<div id="tutor_main_margin">
				...
				<div id="tutor_top_topic">
					<h3 class="topic">리뷰 작성</h3>
					</div>
					<div class="review_div">
						<form method="post" action="reviewWritePro.do" enctype="multipart/form-data">						
						...
						<div id="rev_arti">
							<div class="rev_box">
								<div class="div_subs">
									...
									<div class=tetee_rev>	
	 									 <div class="rev_cont">					  										  
											<textarea name="Re" rows="6" id="review_text" style="width:800px;height:auto; background-color: #d3d3d336;"></textarea>		  			 									  		
	 									  </div>							
									</div>
								</div>			
										 <div class="rev_obj">					  										  				  			 									  		
	 									  </div>	
										<input class="rev_btn" id="review_btn" type="submit" value="리뷰작성">									
